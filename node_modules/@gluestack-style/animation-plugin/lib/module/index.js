...
import { deepMerge, deepMergeObjects, setObjectKeyValue, resolvedTokenization } from './utils';
...
export class AnimationResolver {
  ...
  wrapperComponentMiddleWare() {
    const AnimatedPresenceComp = /*#__PURE__*/React.forwardRef((_ref2, ref) => {
      let {
        children,
        ...props
      } = _ref2;
      ...
      React.Children.toArray(children).forEach(child => {
        var _child$type;
        if ((child === null || child === void 0 || (_child$type = child.type) === null || _child$type === void 0 ? void 0 : _child$type.displayName) === 'StyledComponent') {
          var _this$styledUtils5, _child$type2, _child$props;
          let tokenizedAnimatedProps = {};
          ...
          const componentStyledObject = child === null || child === void 0 || (_child$type2 = child.type) === null || _child$type2 === void 0 || (_child$type2 = _child$type2.styled) === null || _child$type2 === void 0 ? void 0 : _child$type2.config;
          const {
            variantProps,
            restProps
          ...
          if (child.type.styled.resolvedProps) {
            var _child$type3;
            tokenizedAnimatedProps = child === null || child === void 0 || (_child$type3 = child.type) === null || _child$type3 === void 0 || (_child$type3 = _child$type3.styled) === null || _child$type3 === void 0 ? void 0 : _child$type3.resolvedProps;
          } else {
            const variantStyledObject = resolveVariantAnimationProps(variantProps, componentStyledObject);
            const componentStyledObjectWithVariants = deepMergeObjects(componentStyledObject, variantStyledObject);
          ...
          const mergedAnimatedProps = deepMergeObjects({}, tokenizedSxAnimationProps, tokenizedAnimatedProps);
